...
//{
//	CvCapture* capture;
//	capture = cvCaptureFromFile("D:\\lin\\vs\\videos\\bike.avi");//获取视频  
//	if (capture == NULL) {
...
//
//
//	IplImage* tempFrame = NULL;//用于遍历capture中的帧，通道数为3，需要转化为单通道才可以处理  
//	IplImage* currentFrame = NULL;//当前帧  
//	IplImage* previousFrame = NULL;//上一帧  
//							/*
...
//	CvMat* currentFrameMat = NULL; //IplImage要转成CvMat进行处理  
